...
namespace ConsensusChessShared.Content
{
	public class BoardTemplates
	{
        ...
        {
            { DescriptionType.Post, "{{ Board.ActiveSide }} to play. {{ PreviousMoveDescription }}" },
            { DescriptionType.PostWithCheck, "{{ Board.ActiveSide }} to play. {{ PreviousMoveDescription }}. The {{ Checked }} king is in check." },
            { DescriptionType.PostWithCheckmate, " {{ PreviousMoveDescription }} The {{ Checked }} king is checkmated." },
